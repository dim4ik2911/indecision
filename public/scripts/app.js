...
var me = new Student("Dmitrijs Paklons", undefined, "Computer Science");
...
var Traveler = /*#__PURE__*/function (_Person2) {
  ...
  _createClass(Traveler, [{
    ...
    value: function getGreeting() {
      var greeting = _get(_getPrototypeOf(Traveler.prototype), "getGretting", this).call(this);

      if (this.hasHomeLocation()) {
        greeting += "I am visiting from ".concat(this.homeLocation);
      }
...
var orlik = new Traveler("Alex", 22, "Philadelphia");
console.log(orlik.getGreeting());
var mady = new Traveler("Mady", 33);
